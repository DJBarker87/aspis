...
use super::{set_fri_proof_layer_layout, DefaultProverChannel, FriProofLayerLayout, FriProver};
use crate::{
...
#[test]
fn fri_folding_4_with_interpolant_sidecar() {
    set_fri_proof_layer_layout(FriProofLayerLayout::RAW_ROWS_PLUS_INTERPOLANTS);
    let trace_length_e = 12;
    let lde_blowup_e = 3;
    let folding_factor_e = 2;
    let max_remainder_degree = 255;
